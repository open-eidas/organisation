...
- **Environnement d'essai.** Rien de ce qui est listé ci-dessus ne porte de service de confiance qualifié, de clé de production ni de donnée personnelle sensible. Les jetons du banc d'essai n'ont aucune valeur juridique.
...
- **Ce qui est déjà limité.** Ni la vitrine ni le portail n'utilisent de service tiers de suivi, de police de caractères ou de statistiques ; la vitrine ne dépose aucun cookie.
